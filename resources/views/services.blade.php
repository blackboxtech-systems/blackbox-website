@extends('layout', [$activePage = 'Services'])
@section('content')
...
<section class="page-header" style="background-image: url('/assets/images/backgrounds/about-page-bg.jpg');">
            ...
            <div class="container">
                ...
                <div class="page-header__inner slide-title">
                    <h1 class="page-header__heading slide-title__heading">Our Services</h1>
 ...
 <section class="service-three service-two service-one">
            <div class="container">
                <div class="row gx-4 gy-4 gy-md-0">
                    <a href="{{route('services')}}" class="col-xl-3 col-lg-4 col-md-6 service-three__col service-two__col wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                        <div class="service-three__item service-two__item">
                            <div class="service-two__icon-box">
                                <svg class="service-three__icon service-two__icon" xmlns="http://www.w3.org/2000/svg" width="100" height="101" viewBox="0 0 100 101" fill="none">
                                    ...
                                    <path d=" M22.5 50.0066C22.5 63.7875 21.2148 76.2482 19.1445 85.2499C18.1083 89.7547
                            ...
                            <h3 class="service-three__title service-two__title">IT Consultancy</h3>
                        </div><!-- /.service-two__item -->
                    </a>
                    <a href="{{route('services')}}" class="col-xl-3 col-lg-4 col-md-6 service-three__col service-two__col wow animated fadeInUp" data-wow-delay="0.3s" data-wow-duration="1500ms">
                        <div class="service-three__item service-two__item">
                            <div class="service-two__icon-box">
                            ...
                            <h3 class="service-three__title service-two__title">Training</h3>
                        </div><!-- /.service-two__item -->
                    </a>
                    <a href="{{route('services')}}" class="col-xl-3 col-lg-4 col-md-6 service-three__col service-two__col wow animated fadeInUp" data-wow-delay="0.5s" data-wow-duration="1500ms">
                        <div class="service-three__item service-two__item">
                            <div class="service-two__icon-box">
                            ...
                            <h3 class="service-three__title service-two__title">Database Design & Development</h3>
                        </div><!-- /.service-two__item -->
                    </a>
                    <div class="col-xl-3 col-lg-4 col-md-6 service-two__col service-three__col--four wow animated fadeInUp" data-wow-delay="0.7s" data-wow-duration="1500ms">
                    ...
                    <a href="{{route('services')}}" class="col-xl-3 col-lg-4 col-md-6 service-two__col service-three__col--six wow animated fadeInUp" data-wow-delay="0.3s" data-wow-duration="1500ms">
                        <div class="service-two__item">
                            <img src="/assets/images/resources/s-letter.png" alt="" class="service-two__letter-s">
                            <h3 class="service-three__title service-two__title">Social Media Strategy</h3>
                        </div><!-- /.service-two__item -->
                    </a>
                    <a href="{{route('services')}}" class="col-xl-3 col-lg-4 col-md-6 service-three__col service-two__col wow animated fadeInUp" data-wow-delay="0.5s" data-wow-duration="1500ms">
                        <div class="service-three__item service-two__item">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 service-two__col wow animated fadeInUp" data-wow-delay="0.7s" data-wow-duration="1500ms">
                        <div class="service-three__item-btn-box service-two__item">
                            <a href="#" class="service-three__item-btn">
                                <span> <span class="icon-arrow-right-2"></span> <br> All Services</span>
                            </a>
                        </div><!-- /.service-two__item -->
                    </div>
                </div><!-- /.row -->
