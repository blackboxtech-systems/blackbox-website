@extends('layout', [$activePage = 'About'])
@section('content')
...
<section class="page-header" style="background-image: url('/assets/images/backgrounds/about-page-bg.jpg');">
            ...
            <div class="container">
                ...
                <div class="page-header__inner slide-title">
                    <h1 class="page-header__heading slide-title__heading">About Us</h1>
                    <div class="page-header__breadcrumb-wrap">
                        ...
                        <ul class="noile-breadcrumb">
                            ...
                            <li class="noile-breadcrumb__item">About Us</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-6 order-lg-1 order-0">
                        <div class="about-two__content sec-title">
                            <div class="sec-title__top-wrap">
                                <img src="/assets/images/resources/top-title-logo.png" alt="top-title-logo" style="width: 30px;">
                                <p class="sec-title__top">About Us</p>
                            </div>
                            ...
                            <p>We are specialist in software development and consultancy using various technologies we can select an appropriate ap- plication for a project. This may be a web based or a Windows N-tier soloution.</p>
                                ...
                                <div class="sec-title__top-wrap">
                                    <img src="/assets/images/resources/top-title-logo.png" alt="top-title-logo" style="width: 30px;">
                                    <p class="sec-title__top">Our Vision</p>
                                </div>
                                <p class="about-two__desc">To be recognised as an impactful, innovative and effecient IT consultancy firm. As a Nigerian firm in origin but global in scope, we are not bound by any sterotype and will take the utmost advantage of the chareacteristics of our origins.</p>

                                    <div class="sec-title__top-wrap">
                                        <img src="assets/images/resources/top-title-logo.png" alt="top-title-logo" style="width: 30px;">
                                        <p class="sec-title__top">Our Mission</p>
                                    </div>
                                    <p class="about-two__desc">To bring success to our clients and continously contribute to- wards enhancing their corporate values. We pride ourselves in delivering results through out of the box innovative ideas and succeed where others have failed.</p>


                            <!-- <div class="about-two__bottom">
                                <div class="about-two__consulting about-two__bottom-item">
                                    <img src="assets/images/about/about-consulting-2-1.png" alt="about-consulting" class="about-two__consulting-img">
                                    <div class="about-two__consulting-text">
                                        <h3 class="about-two__consulting-title">The Largest Consulting</h3>
                                        <p class="about-two__consulting-desc">Purus vel tincidunt odio ultrices. Sed feugiat feugiat felis. Fusce et nulla.</p>
                                    </div>
                                </div>
                                <div class="about-two__consulting about-two__bottom-item">
                                    <img src="assets/images/about/about-consulting-2-2.png" alt="about-consulting" class="about-two__consulting-img about-two__consulting-img--two">
                                    <div class="about-two__consulting-text">
                                        <h3 class="about-two__consulting-title">Export Of Design Stock</h3>
                                        <p class="about-two__consulting-desc">Purus vel tincidunt odio ultrices. Sed feugiat feugiat felis. Fusce et nulla.</p>
                                    </div>
                                </div>
                            </div> -->
 ...
 <section class="get-work-one">
            <div class="container">
                <div class="get-work-one__wrapper">
                    ...
                    <div class="get-work-one__shape-box">
...
<!-- Get Work One End -->
 ...
 <section class="service-two service-one service-two-two">
                ...
                <div class="row gx-4 gy-4 gy-xl-0">
                        ...
                        <div class="service-two__item">
                            <div class="service-two__icon-box">
                                <svg class="service-two__icon" xmlns="http://www.w3.org/2000/svg" width="100" height="101" viewBox="0 0 100 101" fill="none">
                                    ...
                                    <path d="M22.5 50.0066C22.5 63.7875 21.2148 76.2482 19.1445 85.2499C18.1083 89.7547 16.8817 93.3658 15.5371 95.8385C14.8646 97.0751 14.1752 98.0034 13.4853 98.6172C12.7985 99.2283 12.1367 99.5066 11.5 99.5066C10.8633 99.5066 10.2015 99.2283 9.5147 98.6172C8.8248 98.0034 8.13539 97.0751 7.46294 95.8385C6.11834 93.3658 4.89167 89.7547 3.85555 85.2499C1.78516 76.2482 0.5 63.7875 0.5 50.0066C0.5 36.2257 1.78516 23.765 3.85555 14.7633C4.89167 10.2585 6.11834 6.64739 7.46294 4.1747C8.13539 2.93808 8.8248 2.00977 9.5147 1.39597C10.2015 0.784908 10.8633 0.506592 11.5 0.506592C12.1367 0.506592 12.7985 0.784908 13.4853 1.39597C14.1752 2.00977 14.8646 2.93808 15.5371 4.1747C16.8817 6.64739 18.1083 10.2585 19.1445 14.7633C21.2148 23.765 22.5 36.2257 22.5 50.0066Z" />
                                </svg>
                            </div><!-- /.service-two__icon-box -->
                    ...
                    <a href="{{route('services')}}" class="col-xxl-2 col-xl-3 col-lg-4 col-sm-6 service-two__col service-two__col--five wow animated fadeInUp" data-wow-delay="0.9s" data-wow-duration="1500ms">
                        <div class="service-two__item">
                            ...
                            <h3 class="service-two__title">Database Design & Development</h3>
                        </div><!-- /.service-two__item -->
                    </a>
            ...
            <div class="service-two__shape-box">
                <svg class="service-two__shape-one" width="476" height="558" viewBox="0 0 476 558" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<!-- Solution One End -->
 <!-- Clients One Start -->
 <div class="clients-one @@extraClassName">
            <div class="container">
...
<!-- Clients One End -->
 <!-- Team Three Start -->
 <section class="team-three team">
            <div class="container">
                <div class="team-three__sec-title sec-title">
                    <div class="team-three__top-wrap sec-title__top-wrap">
                        <img src="/assets/images/resources/top-title-logo.png" alt="top-title-logo" style="width: 30px;">
                        <p class="sec-title__top">Our Team</p>
                    </div>
                    <h2 class="team-three__heading sec-title__heading">Meet The Team</h2>
                </div>
                <div class="row g-4">
            ...
            <div class="team-three__shape-box">
                <svg class="team-three__shape-one" xmlns="http://www.w3.org/2000/svg" width="598" height="783" viewBox="0 0 598 783" fill="none">
                    <path d="M596.674 6.10352e-05L0.642517 782.592H143.928L745.727 6.10352e-05H596.674Z" fill="#282828" />
                </svg>
                <svg class="team-three__shape-two" xmlns="http://www.w3.org/2000/svg" width="643" height="629" viewBox="0 0 643 629" fill="none">
                    <path d="M439.616 323.808L371.825 235.652L522.077 0L642.277 0.407804L439.616 323.808Z" fill="white" fill-opacity="0.03" />
                    <path d="M525.762 628.181H392.029L-0.000183105 113.6L136.094 116.546L525.762 628.181Z" fill="white" fill-opacity="0.03" />
                </svg>
            </div><!-- /.tean-three__shape-box -->
</section>
<!-- Team Three End -->
<!-- FAQ One Start -->
<section class="faq-one @@extraClassName">
        <div class="container">
            <div class="row g-4">
                <div class="col-xxl-5 col-xl-6 col-lg-7 order-1 order-sm-0 wow animated fadeInLeft" data-wow-delay="0.1s" data-wow-duration="1500ms">
                    <div class="faq-one__img-wrap">
                        <div class="faq-one__img-wrap-inner-one">
                            <img src="/assets/images/faq/faq-1-1.jpg" alt="faq" class="faq-one__img-one">
                        </div>
                        <div class="faq-one__img-wrap-inner-two">
                            <img src="/assets/images/faq/faq-1-2.jpg" alt="faq" class="faq-one__img-two">
                        </div>
                        <div class="faq-one__shape-box">
                            <div class="faq-one__shape-circle faq-one__shape-circle--one"></div>
                            <div class="faq-one__shape-circle faq-one__shape-circle--two"></div>
                            <svg class="faq-one__shape-one" xmlns="http://www.w3.org/2000/svg" width="86" height="81" viewBox="0 0 86 81" fill="none">
                                <path d="M58.5 0.503418L0.5 58.5034L85.5 80.5034L58.5 0.503418Z" />
                            </svg>
                            <div class="faq-one__shape-two"></div>
                        </div><!-- /.faq-one__shape-box -->
                    </div><!-- /.faq-one__img-wrap -->
                </div>
                <div class="col-xxl-6 col-xl-6 ms-xxl-auto order-0 order-sm-1">
                    <div class="faq-one__content sec-title">
                        <div class="sec-title__top-wrap">
                            <img src="/assets/images/resources/top-title-logo.png" alt="top-title-logo" style="width: 30px;">
                            <p class="sec-title__top"></p>
                        </div>
                        <h2 class="faq-one__heading sec-title__heading">Frequently Asked Questions</h2>
                        <p class="faq-one__desc">Here are answers to frequently asked questions about our services</p>
                            ...
                            <div class="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion">
                                ...
                                <div class="accrodion">
                                    <div class="accrodion-title">
                                        <h4>What if we already have internal technical IT support staff?</h4>
                                    </div>
                                    <div class="accrodion-content" style="">
                                        <div class="inner">
                                            <p>Many of our customers have a designated IT department to handle day to day technical issues and minor network problems. These organizations often count on us for the most critical IT support functions, such as strategic advice, technical projects, IT security and advanced Business Applications support</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accrodion active">
                                    <div class="accrodion-title">
                                        <h4>What makes BlackBox standout from your competitors?</h4>
                                    </div>
                                    <div class="accrodion-content" style="display: none;">
                                        <div class="inner">
                                            <p>Our people and our processes. At Blackbox we invest in our consultants insuring they have constant training and pay attention to every detail.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accrodion">
                                    <div class="accrodion-title">
                                        <h4>How does your consultany help us?</h4>
                                    </div>
                                    <div class="accrodion-content" style="display: none;">
                                        <div class="inner">
                                            <p>Employees perform best doing the things they are good at.With the help of our consultans, you can free up technical headaches that distract you from carrying out your essential day to day tasks. The time and energy spent on figuring out technology can add up. By working working with expert IT consultants you free up your time and resources, getting your focus back on revenue generating projects and opportunities.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accrodion">
                                    <div class="accrodion-title">
                                        <h4>Why would we want a network assessment?</h4>
                                    </div>
                                    <div class="accrodion-content" style="display: none;">
                                        <div class="inner">
                                            <p>Assessing your current technology position will give you a clear picture of the areas that need at- tention. This proactive approach allows for planned upgrades and reduced downtime.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
